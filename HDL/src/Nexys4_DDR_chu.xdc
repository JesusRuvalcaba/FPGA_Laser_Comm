...
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports {tmp_i2c_scl}]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports {tmp_i2c_sda}]
