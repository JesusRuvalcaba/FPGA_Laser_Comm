...
set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33} [get_ports {tmp_i2c_scl}]
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33} [get_ports {tmp_i2c_sda}]
